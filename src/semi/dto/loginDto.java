...
public class loginDto {
	...
	private int userinfo_phonnumber;
	...
	public loginDto(int userinfo_seq, int userinfo_controlno, String userinfo_name, String userinfo_nickname,
			String userinfo_id, String userinfo_password, char userinfo_sex, int userinfo_age, int userinfo_phonnumber,
	...
	public int getUserinfo_phonnumber() {
		return userinfo_phonnumber;
	}



	public void setUserinfo_phonnumber(int userinfo_phonnumber) {
		this.userinfo_phonnumber = userinfo_phonnumber;
	}
