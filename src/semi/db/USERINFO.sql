...
<<<<<<< HEAD
	...
	WHERE MUSIC_ARTIST='2'
	
SELECT * FROM MUSIC;
	
--DELETE MUSIC WHERE MUSIC_ARTIST= '1';
=======
...
INSERT INTO MUSIC
	VALUES(MUSICSEQ.NEXTVAL,'3','1','3_FUNCKEYMUSIC','11','0310','0157','펑키뮤직!','박훈성','조영찬',SYSDATE,'FUNCKEY','Y','1');
...
DELETE FROM MUSIC WHERE MUSIC_SEQ = '11'; 
...
--USERNO가 MUSIC_ARTIST추천.
--내 고유번호, 상대 고유번호.
CREATE TABLE FAVORITEMUSICIAN(
	FAVORITEARTIST_USERNO NUMBER NOT NULL,
	FAVORITEARTIST_ARTIST NUMBER NOT NULL,
);

<<<<<<< HEAD
--USERNO가 MUSICIANSEQ추천.
=======
--USERSEQ가 MUSICIANSONGSEQ추천.
>>>>>>> branch 'master' of https://github.com/zongyeng/SemiProjectBeta.git
--내 고유번호, 노래의 고유번호.
CREATE TABLE FAVORITEMUSIC(
	FAVORITEMUSIC_USERNO NUMBER NOT NULL,
	FAVORITEMUSIC_SONG NUMBER NOT NULL,
	FAVORITEMUSIC_DATE DATE DEFAULT SYSDATE NOT NULL,
	--CONSTRAINT FAVORITEMUSIC_FK FOREIGN KEY(FAVORITEMUSIC_SONG) REFERENCES MUSIC(MUSIC_SEQ)
);
