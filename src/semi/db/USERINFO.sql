...
CREATE TABLE MUSICBOARD(
	MUSICBOARD_BOARDNO NUMBER PRIMARY KEY,
	MUSICBOARD_GROUPNO NUMBER NOT NULL,
	MUSICBOARD_GROUPSQ NUMBER NOT NULL,
	MUSICBOARD_TITLETAB NUMBER NOT NULL,
	MUSICBOARD_DELFLAG CHAR(1) DEFAULT 'N',
	MUSICBOARD_TITLE VARCHAR2(60) NOT NULL,
	MUSICBOARD_CONTENT VARCHAR2(1000) NOT NULL,
	MUSICBOARD_WRITER VARCHAR2(30) NOT NULL,
	MUSICBOARD_REGDATE DATE NOT NULL,
	CONSTRAINT MUSICBOARD_DELFLAG_CHECK CHECK (MUSICBOARD_DELFLAG IN ('Y','N')),
	CONSTRAINT MUSICBOARD_FK FOREIGN KEY(MUSICBOARD_WRITER) REFERENCES USERINFO(USERINFO_SEQ)
);

SELECT TIMELINECOMMENT_TIMELINESEQ,TIMELINECOMMENT_BOARDNO,TIMELINECOMMENT_GROUPNO,TIMELINECOMMENT_GROUPSQ,TIMELINECOMMENT_TITLETAB,TIMELINECOMMENT_TITLE,TIMELINECOMMENT_CONTENT,TIMELINECOMMENT_WRITER,TIMELINECOMMENT_REGDATE FROM TIMELINECOMMENT WHERE TIMELINECOMMENT_TIMELINESEQ='1' ORDER BY TIMELINECOMMENT_GROUPNO DESC, TIMELINECOMMENT_GROUPSQ;

INSERT INTO MUSICBOARD VALUES('1',BOARDNOSEQ.NEXTVAL,GROUPNOSEQ.NEXTVAL,1,0,'N','1번글','1번글 내용','1번',SYSDATE);
INSERT INTO MUSICBOARD VALUES('1',BOARDNOSEQ.NEXTVAL,GROUPNOSEQ.NEXTVAL,1,0,'N','2번글','2번글 내용','2번',SYSDATE);
INSERT INTO MUSICBOARD VALUES('1',BOARDNOSEQ.NEXTVAL,GROUPNOSEQ.NEXTVAL,1,0,'N','3번글','3번글 내용','3번',SYSDATE);
...
INSERT INTO MUSICBOARD
	VALUES(BOARDNOSEQ.NEXTVAL,
		(SELECT MUSICBOARD_GROUPNO FROM MUSICBOARD WHERE MUSICBOARD_BOARDNO=1),
		(SELECT MUSICBOARD_GROUPSQ FROM MUSICBOARD WHERE MUSICBOARD_BOARDNO=1)+1,
		(SELECT MUSICBOARD_TITLETAB FROM MUSICBOARD WHERE MUSICBOARD_BOARDNO=1)+1,
		'RE:1번글 답변','1번글 답변 내용','유저2',SYSDATE);
	
UPDATE MUSICBOARD
	SET MUSICBOARD_GROUPSQ = MUSICBOARD_GROUPSQ+1
	WHERE MUSICBOARD_GROUPNO = (SELECT MUSICBOARD_GROUPNO FROM MUSICBOARD WHERE MUSICBOARD_BOARDNO=1)
	AND MUSICBOARD_GROUPSQ > (SELECT MUSICBOARD_GROUPSQ FROM MUSICBOARD WHERE MUSICBOARD_BOARDNO=1);

SELECT * FROM MUSICBOARD ORDER BY MUSICBOARD_GROUPNO DESC, MUSICBOARD_GROUPSQ;
