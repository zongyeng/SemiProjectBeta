...
<%
	...
	String MUSIC_TITLE = "";
	String MUSIC_HL_TIME = "";
	String MUSIC_CONTENT = "";
	String MUSIC_COMPOSER = "";
	String MUSIC_LYRICIST = "";
	String MUSIC_TAG = "";
	...
	try {
		...
		MUSIC_TITLE = multi.getParameter("MUSIC_TITLE");
		MUSIC_HL_TIME = multi.getParameter("MUSIC_HL_TIME");
		MUSIC_CONTENT = multi.getParameter("MUSIC_CONTENT");
		MUSIC_COMPOSER = multi.getParameter("MUSIC_COMPOSER");
		MUSIC_LYRICIST = multi.getParameter("MUSIC_LYRICIST");
		MUSIC_TAG = multi.getParameter("MUSIC_TAG");
