...
<style type="text/css">
	.section1 { width : 100%; height : 500px;}
	...
	.section3 { width : 100%; height : 500px;}
	.section3div1div { width : 100%; height: 100px; color : white;
					font-size: 30px; text-align: center; padding-top: 50px;
					font-weight: bold;}
	.section3div2 { width : 70%; height :600px; margin:20px auto;}
	.section3div2div1 { width : 100%; height: 50px; color : black;
					font-size: 30px; text-align: center; padding-top: 10px;
					font-weight: bold; display : table;} 
	.section3div2div1div {display: table-cell; vertical-align: middle;
						border-top: 2px groove gray; border-bottom:2px double gray;}
	.section3div2div2 {width : 100%; height :600px; margin:20px auto;}
	.section3div2div2div1 { display : flex; }
	.section3div2div2div1div { display : flex-basis; width : calc(20% - 2px); ;
								border : solid 1px;}
	.section3div2div2div1divdiv1 { width : 95%; height: 190px; margin : 0 auto; border : solid 1px;}
	.section3div2div2div1divdiv2 { width : 95%; height: 30px;text-align : center; magin-top:5px;}
